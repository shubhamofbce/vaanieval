...
export default function Page() {
  return <>
    ...
    <section className="content-shell">
      ...
      <div className="callout"><strong>Run the workflow in your environment.</strong><p>VaaniEval can be self-hosted under AGPL-3.0. Operators control provider permissions, evaluator configuration, retention, and access policies.</p><Link className="text-link" href="/open-source">Review the AGPL-3.0 terms <span aria-hidden="true">→</span></Link></div>
