...
export default function Page() {
  return <>
    ...
    <section className="content-shell">
      ...
      <div className="callout"><strong>Choose your next step.</strong><p>Book a walkthrough for your team, or inspect the source and deployment guidance directly.</p><div className="inline-links"><BookingButton event="calendar_booking_open_source_open">Book a demo</BookingButton><GitHubCta className="button button-secondary" event="github_star_open_source_click" /><a className="text-link" href="https://github.com/shubhamofbce/vaanieval/blob/main/DEPLOYMENT.md" target="_blank" rel="noreferrer">Read deployment guidance <span aria-hidden="true">→</span></a></div></div>
    </section>
  </>
}
