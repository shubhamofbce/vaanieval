...
export const alternativesPost: BlogPost = {
  ...
  content: [
    ...
    'Proprietary SaaS platforms often limit custom evaluation criteria to particular tiers. VaaniEval source is available for inspection, while modification, deployment, and derivative works require prior written permission.',
    ...
    'An authorized self-hosted voice AI evaluation deployment gives engineering and QA teams more control over their infrastructure and evaluation parameters, while also transferring maintenance, security, reliability, and scaling responsibilities to the operator.',
