...
export const cekuraPost: BlogPost = {
  ...
  content: [
    ...
    'Here is an in-depth look at Cekura\'s real-time SaaS observability platform versus VaaniEval\'s self-hosted, open-source QA and evaluation workspace.',
    ...
    '- **VaaniEval (Self-Hosted Open Source):** VaaniEval is entirely free and open-source. Because you host it in your own environment (AWS, GCP, Vercel, or on-premise), you only pay for your underlying database and LLM evaluator usage (e.g., Azure OpenAI/Anthropic). Sensitive audio files and transcripts never leave your security perimeter, satisfying strict privacy policies.',
    ...
    'Choose **VaaniEval** if you want to perform post-call audits, require strict data compliance, want to self-host the entire evaluation database, and prefer a developer-friendly, open-source tool.',
