...
export const hammingPost: BlogPost = {
  ...
  description: 'Compare Hamming AI and VaaniEval for voice agent testing. Understand the trade-offs of open-source self-hosted QA vs proprietary SaaS simulation.',
  ...
  content: [
    ...
    'This comparison outlines the key trade-offs between Hamming AI\'s SaaS-based simulation platform and VaaniEval\'s open-source QA workspace, helping you choose the right fit for your team\'s workflow.',
    ...
    'VaaniEval is an open-source QA workspace licensed under AGPL-3.0 that can be self-hosted. Instead of focusing primarily on synthetic simulations, VaaniEval is built to import real production conversations from voice providers like ElevenLabs, Vapi, and Bolna. It runs evaluator-backed scorecards on actual customer calls, allowing QA and engineering teams to inspect transcripts, play audio, and analyze scores within their own infrastructure.',
    ...
    'Choose **VaaniEval** if you manage production voice agents, need a dedicated QA workspace for real calls, and want an open-source self-hosted deployment.',
