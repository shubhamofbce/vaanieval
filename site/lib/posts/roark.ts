...
export const roarkPost: BlogPost = {
  ...
  description: 'Compare Roark and VaaniEval. Find out whether an audio-native debugging SaaS or a permissioned self-hosted QA dashboard fits your voice agent team.',
  ...
  content: [
    ...
    'This comparison outlines the key trade-offs between Roark\'s audio-native debugging SaaS and VaaniEval\'s source-available QA and evaluation workspace.',
    '## Key Product Focuses',
    ...
    '- **VaaniEval (Permissioned Self-Hosting):** Authorized users can deploy the stack—FastAPI API, PostgreSQL database, React UI, and background workers—within their own infrastructure. Commercial or noncommercial use requires prior written permission.',
    ...
    'Choose **VaaniEval** if you want to verify qualitative business outcomes (Task Completion, Info Capture) and are prepared to request permission for self-hosting.',
