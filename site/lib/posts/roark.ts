...
export const roarkPost: BlogPost = {
  ...
  description: 'Compare Roark and VaaniEval. Find out whether an audio-native debugging SaaS or an open-source self-hosted QA dashboard fits your voice agent team.',
  ...
  content: [
    ...
    'This comparison outlines the key trade-offs between Roark\'s audio-native debugging SaaS and VaaniEval\'s open-source QA and evaluation workspace.',
    '## Key Product Focuses',
    ...
    '- **VaaniEval (Open-Source Self-Hosting):** Teams can deploy the stack—FastAPI API, PostgreSQL database, React UI, and background workers—within their own infrastructure under AGPL-3.0.',
    ...
    'Choose **VaaniEval** if you want to verify qualitative business outcomes (Task Completion, Info Capture) and want an open-source self-hosted workflow.',
