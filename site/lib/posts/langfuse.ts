...
export const langfusePost: BlogPost = {
  ...
  description: 'Compare open-source Langfuse with open-source VaaniEval: general-purpose LLM tracing vs a voice-native QA workspace.',
  publishedAt: '2026-07-18',
  readingTime: '6 min read',
  category: 'Alternatives',
  content: [
    'For developers who prioritize data privacy and cost control, self-hosting can be attractive. Langfuse and VaaniEval are open source, though their licenses and product scopes differ. The tools also serve different development needs.',
    ...
    '- **VaaniEval:** It is licensed under AGPL-3.0. Modified versions offered to users over a network must offer those users the corresponding source code.',
    '- **Operating cost:** A self-hosted deployment still incurs infrastructure, maintenance, and evaluator-provider costs.',
    '## When to Use Which?',
    ...
    'Choose **VaaniEval** if you are deploying voice agents (via ElevenLabs, Vapi, or Bolna), need an integrated workspace to listen to call recordings next to transcripts, and want to evaluate voice-specific outcomes in an open-source system.',
