...
export const braintrustPost: BlogPost = {
  ...
  content: [
    ...
    'VaaniEval is an MIT-licensed, self-hosted QA platform built specifically for **voice AI agents**. It focuses on importing real customer calls, displaying synchronized transcripts and audio player controls, and running voice-oriented evaluator checklists.',
    ...
    '- **VaaniEval (Self-Hosted Open Source):** VaaniEval is entirely free, open-source, and self-hosted. By running VaaniEval on your own infrastructure, your voice recordings, transcripts, and model keys remain completely private and secure. This is ideal for agencies and developers who want complete data control without licensing overhead.',
    ...
    'Choose **VaaniEval** if you are building production voice agents, need a dedicated audio-transcript QA workspace, require strict self-hosted data ownership, and prefer an open-source tool.',
