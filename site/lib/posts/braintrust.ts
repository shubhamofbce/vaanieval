...
export const braintrustPost: BlogPost = {
  ...
  content: [
    ...
    'VaaniEval is a source-available QA platform built specifically for **voice AI agents**. It focuses on importing real customer calls, displaying synchronized transcripts and audio player controls, and running voice-oriented evaluator checklists. Self-hosting requires prior written permission.',
    ...
    '- **VaaniEval (Permissioned Self-Hosting):** VaaniEval source is available for inspection, and authorized users can self-host it in their own infrastructure. Commercial or noncommercial use requires prior written permission.',
    ...
    'Choose **VaaniEval** if you are building production voice agents, need a dedicated audio-transcript QA workspace, and are prepared to request permission for a self-hosted deployment.',
