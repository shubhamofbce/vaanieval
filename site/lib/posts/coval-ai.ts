...
export const covalPost: BlogPost = {
  ...
  content: [
    ...
    '- **VaaniEval (Permissioned Self-Hosting):** The source is available for inspection, and authorized users can self-host VaaniEval on their own infrastructure. Commercial or noncommercial use requires prior written permission.',
    ...
    'Choose **VaaniEval** if you want to inspect real production calls, need a dedicated audio-transcript QA workspace, and are prepared to request permission for a self-hosted setup.',
