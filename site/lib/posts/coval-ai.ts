...
export const covalPost: BlogPost = {
  ...
  content: [
    ...
    '- **VaaniEval (Open-Source Self-Hosting):** VaaniEval is licensed under AGPL-3.0, so teams can self-host it in their own infrastructure. Modified versions offered to users over a network must offer those users the corresponding source code.',
    ...
    'Choose **VaaniEval** if you want to inspect real production calls, need a dedicated audio-transcript QA workspace, and want an open-source self-hosted setup.',
